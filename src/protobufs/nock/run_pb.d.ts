...
export class Request extends jspb.Message { 
    ...
    setJammedProgram(value: Uint8Array | string): Request;

    hasTextProgram(): boolean;
    clearTextProgram(): void;
    getTextProgram(): string;
    setTextProgram(value: string): Request;
    clearInputsList(): void;
    getInputsList(): Array<nock_input_pb.Input>;
    setInputsList(value: Array<nock_input_pb.Input>): Request;
    addInputs(value?: nock_input_pb.Input, index?: number): nock_input_pb.Input;
...
export namespace Request {
    export type AsObject = {
        ...
        textProgram: string,
        inputsList: Array<nock_input_pb.Input.AsObject>,
    }
...
export class Response extends jspb.Message { 
    ...
    setSuccess(value?: nock_result_pb.Success): Response;

    hasError(): boolean;
    clearError(): void;
    getError(): nock_result_pb.Error | undefined;
    setError(value?: nock_result_pb.Error): Response;
