...
export class Request extends jspb.Message { 
    ...
    setFiltersList(value: Array<Filter>): Request;
...
export class Response extends jspb.Message { 
    ...
    setResourcesList(value: Array<Uint8Array | string>): Response;
...
export class Filter extends jspb.Message { 
    ...
    setOwner(value: Uint8Array | string): Filter;
    ...
    setKind(value: Uint8Array | string): Filter;
